...
export function WhatsAppButton() {
  return (
    <a
      ...
      className="group fixed bottom-[max(1.25rem,env(safe-area-inset-bottom))] right-[max(1.25rem,env(safe-area-inset-right))] z-40 flex items-center gap-3 rounded-full bg-[#25d366] pl-4 pr-1 text-white shadow-[0_10px_30px_-10px_rgba(0,0,0,0.45)] transition-transform hover:scale-[1.04] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#25d366] md:bottom-7 md:right-7"
    >
      <span className="hidden text-xs font-medium uppercase tracking-[0.08em] sm:block">
        Chat with us
      </span>
