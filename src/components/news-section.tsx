...
export function NewsSection({ className = "" }: { className?: string }) {
  ...
  return (
    <section id="news" className={`px-5 py-14 sm:px-10 md:px-16 md:py-24 lg:px-24 ${className}`}>
        ...
        {visible.map((item) => (
          ...
          >
            ...
            <div className="flex flex-1 flex-col p-5">
              <h3 className="line-clamp-2 font-display text-2xl italic leading-tight text-foreground">
                {item.title}
              </h3>
              ...
              <div className="mt-6 flex items-center justify-between border-t border-border pt-4">
                ...
                <span className="inline-flex size-8 items-center justify-center border border-border text-primary transition-colors group-hover:border-primary group-hover:bg-primary group-hover:text-primary-foreground">
